...
formular.addEventListener("submit", (e)=>{
    ...
    for(let i = 0; i < amountVal; i++){
        ...
        createPromise(i, currentDelay).then(()=>{
            (0, _notiflixDefault.default).Notify.success(`✅ Fulfilled promise ${i} in ${currentDelay} ms`);
        }).catch(()=>{
            (0, _notiflixDefault.default).Notify.failure(`❌ Rejected promise ${i} in ${currentDelay} ms`);
        });
